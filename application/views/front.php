...
<!--        </div>-->
        ...
        <div class="main-bar">
            <h3>
                <i class="fa fa-home"></i> Into the data</h3>
        </div><!-- /.main-bar -->
    </header>
...
<div id="footer">
    <p>2014 &copy; intothedata. <a href="https://github.com/onokumus/Bootstrap-Admin-Template" target="_blank">Metis</a> template</p>
</div>
