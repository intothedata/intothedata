...
<body data-spy="scroll" data-target="#dw_toc">
    ...
    <div id="dokuwiki__site" ><div id="dokuwiki__top"
        ...
        <div class="navbar navbar-default navbar-fixed-top">
            ...
            <div class="navbar-header">
                ...
                <?php tpl_link(wl(), "<img src='/assets/img/intothedata_logo.png' border=0 alt='".$conf['title']."' />",'accesskey="h" title="[H]" class="navbar-brand-logo"') ?>
        ...
        <div class="container not-header">
            ...
            <section class="wrapper row"><!-- PAGE ACTIONS -->
                <!-- ********** CONTENT ********** -->
                <!-- 컨텐트 폭을 11에서 9로 줄임 2014년 11월 10일 월요일 -->
                <div id="dokuwiki__content" class="<?php
                    if ($ACT == 'show' && $sidebar_contents != ""):
                        ?>col-sm-<?php echo 10 - $sidebarCols; ?><?php
                        if ($sidebarPos == "Left"):
                ...
                <aside id="dokuwiki__aside" class="col-sm-<?php echo $sidebarCols; ?><?php
                    if ($sidebarPos == "Left"):
                        ?> col-sm-pull-<?php echo 10 - $sidebarCols; ?><?php
                    endif; ?>">
    ...
    copyright by intothedata. all rights reserved.
</body>
</html>
